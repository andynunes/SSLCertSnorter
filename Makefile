...
DIST_COMMON = $(am__configure_deps) $(srcdir)/Makefile.am \
	...
	$(srcdir)/snort.pc.in $(top_srcdir)/configure COPYING \
...
am__base_list = \
  ...
  sed '$$!N;$$!N;$$!N;$$!N;s/\n/ /g'
man8dir = $(mandir)/man8
am__installdirs = "$(DESTDIR)$(man8dir)" "$(DESTDIR)$(pkgconfigdir)"
NROFF = nroff
MANS = $(man_MANS)
DATA = $(pkgconfig_DATA)
...
ACLOCAL = ${SHELL} /root/snorttmp/snort-2.9.1/missing --run aclocal-1.11
AMTAR = ${SHELL} /root/snorttmp/snort-2.9.1/missing --run tar
AR = ar
AUTOCONF = ${SHELL} /root/snorttmp/snort-2.9.1/missing --run autoconf
AUTOHEADER = ${SHELL} /root/snorttmp/snort-2.9.1/missing --run autoheader
AUTOMAKE = ${SHELL} /root/snorttmp/snort-2.9.1/missing --run automake-1.11
AWK = mawk
CC = gcc
...
CPP = gcc -E
CPPFLAGS = -DDYNAMIC_PLUGIN -I/usr/local/include -DZLIB -DGRE -DMPLS -DPREPROCESSOR_AND_DECODER_RULE_EVENTS -DPPM_MGR -DDEBUG_MSGS -DDEBUG -I/usr/include/mysql -DENABLE_MYSQL -DENABLE_PAF -DENABLE_REACT -DENABLE_RESPOND -DENABLE_RESPONSE3 -DSF_WCHAR -DSUP_IP6 -DTARGET_BASED -DPERF_PROFILING -DSNORT_RELOAD -DNORMALIZER -DACTIVE_RESPONSE
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
DSYMUTIL = 
...
LD = /usr/bin/ld
LDFLAGS =  -L/usr/lib/i386-linux-gnu -lpcre -L/usr/local/lib -ldnet -L/usr/lib
LEX = flex
LIBOBJS = 
LIBPRELUDE_CFLAGS = 
LIBPRELUDE_CONFIG = 
...
LIBS = -lmysqlclient -lz -lz -ldaq_static -ldnet -lpcre -lpcap -lnsl -lm -lm  -ldl -L/usr/local/lib -ldaq_static_modules  -lsfbpf -lpcap -lsfbpf -lpcap -lz -lpthread -lpthread -lpthread
LIBTOOL = $(SHELL) $(top_builddir)/libtool
LIPO = 
LN_S = ln -s
LTLIBOBJS = 
MAINT = #
MAKEINFO = ${SHELL} /root/snorttmp/snort-2.9.1/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
OBJDUMP = objdump
...
XCCFLAGS = 
YACC = bison -y
abs_builddir = /root/snorttmp/snort-2.9.1
abs_srcdir = /root/snorttmp/snort-2.9.1
abs_top_builddir = /root/snorttmp/snort-2.9.1
abs_top_srcdir = /root/snorttmp/snort-2.9.1
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /root/snorttmp/snort-2.9.1/install-sh
...
SUBDIRS = src doc etc templates contrib rpm schemas m4 preproc_rules tools
...
snort.pc: $(top_builddir)/config.status $(srcdir)/snort.pc.in
...
installdirs-am:
	for dir in "$(DESTDIR)$(man8dir)" "$(DESTDIR)$(pkgconfigdir)"; do \
