...
typedef struct _stream_api
{
     ...
     *
     */
    int (*add_session_alert)(void *, SFSnortPacket *p, uint32_t, uint32_t, int);
     ...
     *
     */
    int (*log_session_extra_data)(void *, void *, SFSnortPacket *p, uint32_t, uint32_t, uint32_t, uint32_t, LogExtraData);
